#!/bin/bash
# STAGE 88 -- stage 86's driver, updated to require stage 87's atomically-
# safe `best` binary. Every earlier version of this pipeline (76/82/86)
# had a real, reproducible race: BEST must be built from
# 87_atomic_dump.cpp, not 45_sweep_loop.cpp, or literal.txt/perm.u32 can
# be read empty/partial by seqpar/permcoder under this same task-level
# overlap -- confirmed to fail 3/3 times with the old binary under this
# exact polling logic (see stage 87's header for the full story). This is
# not optional: point BEST at a binary built from 87_atomic_dump.cpp.
# ============================================================================
#
