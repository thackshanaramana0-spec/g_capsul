# Best case — the canonical configuration and its measured result
...
**Pipeline: `41_malloc_trim.cpp`** — the newest file, and therefore the one
carrying every accepted change: RC-only self-matching (36), the packed mapping
index (40), and the arena release (41), which in turn inherit maximal MEM
extension (33), lazy parsing (34), best-match placement (28), the probe filter
(26), packed reads (21), and the rest.

    g++ -O3 -march=native -pthread -o best 41_malloc_trim.cpp
