...
Improvement is the competitor's archive size divided by G\_CAPSUL's, per row — matching the
methodology in the manuscript's Table 1 (there reported as a single "better competitor"
column; here broken out against each tool separately).

| dataset | original | G_CAPSUL | SPRING | Genozip | lossless | vs SPRING | vs Genozip |
|---|---:|---:|---:|---:|:---:|---:|---:|
| ERR5181310 | 471,183,048 | **8,679,796** | 9,984,000 | 9,222,378 | 3/3 | 1.15× | 1.06× |
| SRR554369 | 456,443,722 | **57,286,360** | 59,197,440 | 88,813,291 | 3/3 | 1.03× | 1.55× |
| ERR552797 | 431,078,636 | **46,970,874** | 52,131,840 | 82,799,532 | 3/3 | 1.11× | 1.76× |
| SRR2584863 | 695,163,748 | **68,429,027** | 74,086,400 | 114,589,268 | 3/3 | 1.08× | 1.67× |
| SRR29296997 | 210,225,246 | **15,663,251** | 17,541,120 | 27,233,698 | 3/3 | 1.12× | 1.74× |
| ERR12954017 | 333,144,048 | **15,164,609** | 16,998,400 | 39,429,441 | 3/3 | 1.12× | 2.60× |
| SRR065390 | 11,282,985,734 | **887,410,845** | 942,643,200 | 1,597,083,547 | 3/3 | 1.06× | 1.80× |
| SRR40271341 | 290,894,264 | **40,551,005** | 45,783,040 | 62,260,895 | 3/3 | 1.13× | 1.54× |
| ERR17740259 | 1,336,957,140 | **83,196,587** | 92,395,520 | 161,813,831 | 3/3 | 1.11× | 1.94× |
| SRR37283774 | 1,019,818,902 | **67,201,215** | 71,342,080 | 94,989,797 | 3/3 | 1.06× | 1.41× |
| DRR976266 | 2,248,042,490 | **56,541,178** | 61,757,440 | 201,135,432 | 3/3 | 1.09× | 3.56× |
| SRR36741279 | 1,661,157,034 | **106,248,319** | 117,616,640 | 194,658,228 | 3/3 | 1.11× | 1.83× |
| SRR32429602 | 1,868,917,402 | **55,118,753** | 57,548,800 | 107,183,883 | 3/3 | 1.04× | 1.94× |
| SRR39257532 | 1,761,853,698 | **108,270,384** | 153,856,000 | 227,016,274 | 3/3 | 1.42× | 2.10× |
| SRR10676752 | 15,372,502,354 | **1,650,034,057** | 1,718,548,480 | 2,954,900,932 | 3/3 | 1.04× | 1.79× |
| HG002 | 4,279,197,941 | **573,767,964** | 598,190,080 | 950,997,605 | 3/3 | 1.04× | 1.66× |
| HG003 | 4,279,569,332 | **567,123,999** | 591,144,960 | 944,223,940 | 3/3 | 1.04× | 1.66× |
| HG004 | 4,279,327,517 | **606,192,930** | 634,746,880 | 1,041,658,192 | 3/3 | 1.05× | 1.72× |
| HG005 | 6,809,023,884 | **997,518,994** | 1,081,384,960 | 1,694,512,440 | 3/3 | 1.08× | 1.70× |
| **aggregate** | **59,087,486,140** | **6,011,370,147** | 6,396,897,280 | 10,594,522,604 | **57/57** | **1.06×** | **1.76×** |
