...
`docs/FAILURES_AND_REFUTED_IDEAS.md` Part A (also cited in `CLAUDE.md` §6.3
...
data-loss bugs (`CLAUDE.md` §6.3, `docs/FAILURES_AND_REFUTED_IDEAS.md` Part
...
four cataloged in `CLAUDE.md` §6.3. All six are required for a decoder to
