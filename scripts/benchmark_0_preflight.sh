...
say "      T3.3 query    — ALL 19 (partial random access, reference-free coords)"
say "      est: see the PROJECTION below"
say ""
...
# at the end.
#
# BTR_NOTES.md rule 6: projections are SANITY CHECKS ONLY. Fresh server numbers
...
say "    - query    NOT uncontested: SPRING --decompress-range (by read index),"
say "               genocat --regions / CRAM (by REFERENCE coordinate). Ours is by"
say "               pseudogenome coordinate with no reference -- state it that way."
